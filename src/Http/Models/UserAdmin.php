...
class UserAdmin extends Model{// implements AuthenticatableContract, CanResetPasswordContract {
    ...
    private function _getButton($id) {
        $showUrl = URL::route('admin.user.show',array('in_ajax'=>1, 'user_id'=>$id));
        $editUrl = URL::route('admin.user.edit', array('user_id' => $id));
        $pwdUrl = URL::route('admin.user.pwd', array('user_id' => $id));
        $setCategory = URL::route('admin.user.setCategoryShow', array('user_id' => $id));
        $setSection = URL::route('admin.user.setSectionShow', array('user_id' => $id));
		$setMenu = URL::route('admin.user.setMenushow',array('user_id' =>$id));
        $html = <<<HTML
				...
				<i class="icon-unlock bigger-120" title="修改密码"></i>
                           ...
                           <div class="inline position-relative">
                            ...
                            <ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
									<li>
                                            <a title="" data-rel="tooltip" class="tooltip-warning" href="#" onclick="$.weitac.formShow('$setMenu');" data-original-title="Reject">
                                                    <span class="orange">
                                                        权限分配
                                                    </span>
                                            </a>
                                    ...
                                    <li>
                                            <a title="" data-rel="tooltip" class="tooltip-warning" href="#" onclick="$.weitac.formShow('$setCategory');" data-original-title="Reject">
                                                    <span class="orange">
                                                           栏目权限
                                                    </span>
                                            </a>
									...
									<li>
                                            <a title="" data-rel="tooltip" class="tooltip-warning" href="#" onclick="$.weitac.formShow('$setSection');" data-original-title="Reject">
                                                    <span class="orange">
                                                           区块权限
                                                    </span>
                                            </a>
                                    ...
                                    <li>
                                            <a title="" data-rel="tooltip" class="tooltip-error" href="#" onclick="del($id);" data-original-title="Delete">
                                                    <span class="red">
                                                            删除
                                                    </span>
                                            </a>
