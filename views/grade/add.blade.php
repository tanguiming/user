				...
				<div class="row-fluid">
					<div class="span12">
						<div class="form-group">
							...
							<div class="col-xs-8">
								<input type="text" class="form-control" id="form-field-1" style="width:200px;float:left;" placeholder="请输入级别名称" value="" name="title" />
								<div style="width:100px;height:20px;float:left;margin-top:8px;margin-left:20px;">
									<input type="text" id="picker" name="colorvalue" value=""></input>
								</div>
							</div>
						</div>
						<div id="title" class="form-group">
							...
							<div class="col-xs-8" >
								<input type="number" name="grade" value="" class="form-control" style="width: 200px;" placeholder="请输入等级"/>
							</div>
						</div>
						<div class="form-group" id="select_2">
							...
							<div class="col-xs-8" style="margin-top:5px;float:left;">
								<div class="am-form-group">
									<input class="form-control" name="lower" style="width:28%;float:left;" placeholder="请输入最低值"/>
									<div style="float:left;margin-top: 8px;">&nbsp;&nbsp;至&nbsp;&nbsp;</div>
									<input class="form-control" name="toplimit" style="width:28%;float:left;" placeholder="请输入最高值"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-8" >
								<input type="text" name="icon" value="" class="form-control" style="width: 350px;float:left;margin-right:7px;" id="thumb" placeholder="请输入商品图片【请控制在100K】"/><a href="javascript:;" class="btn btn-sm btn-primary" id="pickbut1" onclick="ownup('pickbut1','thumb');">上传</a>
							</div>
						</div>
						<div>
