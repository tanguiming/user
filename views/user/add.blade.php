       ...
       <div class="span12">
				<div class="col-md-12">
					<div id="user-main-box" class="show">
						...
						<div class="form-group"><label>是否启用</label> <input type="checkbox" name ="status" id="status"  value="1" class="js-switch1" checked />&nbsp;&nbsp;&nbsp;<label>是否为管理员</label> <input type="checkbox" name ="system" id="system"  value="1" class="js-switch2" /></div>
						<div class="form-group">
							<label >选择角色</label>
