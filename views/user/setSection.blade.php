    ...
    <body class="gray-bg">
						...
						<div class="row-fluid">
							<div class="widget-box span6">
								<div class="widget-header header-color-blue2">
									<h4 class="lighter smaller">区块分配</h4>
								</div>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				$.ajax({
					url: "{{URL::route('admin.user.ajax.secton.tree')}}",//admin.user.ajax.tree admin.aca.ajax.tree
					type: 'GET',
					dataType: 'json',
			...
			function check(flag=true){
				...
				if (flag){
					...
					alert(acaString);return;
					if(acaString !=''){
						var index= index = window.parent.setSectionUpdate(acaString);
					}else{
						alert('请选择对应权限或者关闭');
						return false;
					}
