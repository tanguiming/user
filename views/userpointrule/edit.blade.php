            ...
            <div class="modal-body">
                <form id="wt-forms-edit" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
							<input type="hidden" data-rel="tooltip" name ="id" value="{{$id}}" id="form-field-1" />
					...
					<div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <textarea rows="5" cols="43" placeholder="请填写赚币名称描述例如:用户登陆" id="content" name="content">{{$content}}</textarea> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">获得币种</label>
                        <div class="col-xs-8">
                            <input type="text" name="currency" value="{{$currency}}" class="form-control input-sm" > 
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-xs-3 control-label">经验值</label>
                        <div class="col-xs-8">
                            <input type="text" name="value" value="{{$value}}" class="form-control input-sm"> 
                        </div>
                    </div>
