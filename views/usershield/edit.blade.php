					...
					<div class="form-group" id="select_2">
						...
						<div class="col-xs-8" style="margin-top:5px;">
							<div class="am-form-group">
								<input class="laydate-icon" id="start" name="periodtimestart" value="{{$periodtimestart}}" readonly="readonly" style="width:60%;" placeholder="请输入开始屏蔽时间"/>
								<br/><br/>
								<input class="laydate-icon" id="end" name="periodtimend" value="{{$periodtimend}}" readonly="readonly" style="width:60%;" placeholder="请输入结束屏蔽时间"/>
							</div>
						</div>
					</div>
