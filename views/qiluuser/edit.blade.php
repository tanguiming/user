            ...
            <div class="span12">
                <div class="col-md-12">
                    <div id="user-main-box" class="show">
						...
						<div class="form-group">
							...
							@if(!empty($bm_id))
								<div class="radio radio-success radio-inline">
								 ...
								 <div class="radio radio-success radio-inline">
	                                <input type="radio" id="push_type2" value="0" name="push_type" onclick="push_type();" >
								...
								<div class="radio radio-success radio-inline">
	                                <input type="radio" id="push_type2" value="0" name="push_type"  onclick="push_type();"  checked>
	                                <label for="input_source_type2">不推送</label>
	                            </div>
							@endif
						...
						<input type="hidden" name ="status"  id="status"  value="1" class="js-switch1"checked="checked" />&nbsp;&nbsp;&nbsp;<label></label>
						<input type="hidden" name ="system"  id="system"  value="1" class="js-switch2"  checked="checked"  /></div>
                        <div class="form-group">
                            <label >选择角色</label>
